...
extension DetailsViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .aboutEventCell:
            ...
            cell.dateAndLocalLabel.text = "\(cellModel.dayOfTheWeek), \(cellModel.dayOfTheMonth) June - \(cellModel.startingTime.prefix(2)):\(cellModel.startingTime.suffix(2)) - \(cellModel.endingTime.prefix(2)):\(cellModel.endingTime.suffix(2)) - \(cellModel.location)"
