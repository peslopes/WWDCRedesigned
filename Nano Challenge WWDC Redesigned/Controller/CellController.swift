...
class CellController: UIViewController {
    ...
    var keynotes: [Cell] = [
        ...
        Cell(image: "GeoffC", speaker: "Geoff C.", extraSpeaker: 2, startingTime: "1900", endingTime: "1940", location: "Hall 2", title: "Automating App Store Connect", sessionNumber: 303, track: TrackType.devTrack, favorite: false, eventDescription: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vehicula leo quis tincidunt aliquam. Etiam eget posuere odio. Ut consectetur pharetra lectus, id feugiat mauris auctor a.", imageMap: "ExampleMap", speakerFunction: "Director of something", speakerCompany: "Apple Inc.", speakerDescription: "Proin elementum nisi ut accumsan suscipit. Mauris interdum elit sed sem finibus iaculis. Mauris vestibulum aliquam ante eu vulputate. Nulla ultrices vestibulum fringilla. In hac habitasse platea dictumst. Donec ac vehicula nunc. Duis vel congue nulla, elementum bibendum sem. Aenean blandit quam vel scelerisque posuere. Duis porta eu enim sit amet mollis. Quisque sed lorem vitae odio congue euismod. Nunc risus metus, iaculis vitae aliquam at, iaculis et elit. In aliquet nibh eget risus laoreet egestas. Nunc at volutpat orci, vel mattis enim. Quisque fringilla tellus justo, vitae varius tortor finibus ut. Phasellus interdum ipsum dui, a lacinia nisl congue id.", cellType: .keynoteCell, dayOfTheWeek: .Thursday, dayOfTheMonth: 8),
        Cell(image: "FrankDoepke", speaker: "Frank Doepke", extraSpeaker: 0, startingTime: "1900", endingTime: "1940", location: "Hall 1", title: "Vision with Core ML", sessionNumber: 717, track: TrackType.featuredTrack, favorite: false, eventDescription: "Cras laoreet sapien eu risus rutrum porttitor. Ut condimentum urna sed leo eleifend finibus. Pellentesque et euismod justo, vel eleifend lectus. Ut sollicitudin luctus tortor eget consequat. Etiam a lectus justo. Curabitur eu ligula dictum, tempor purus ac, auctor odio. Nunc maximus malesuada dictum. Suspendisse mollis arcu sem, id tincidunt lectus dictum eget. Integer sit amet augue id velit dapibus viverra vel maximus sapien. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Quisque eu condimentum leo, eget consectetur nunc. Vivamus elementum lobortis dui at molestie.", imageMap: "ExampleMap", speakerFunction: "Director of Photography", speakerCompany: "Pixar Animation Studios", speakerDescription: "Aliquam nunc ipsum, suscipit vel efficitur eget, euismod nec tellus. Suspendisse ut bibendum quam. Etiam pellentesque nulla quis arcu vulputate finibus.", cellType: .keynoteCell, dayOfTheWeek: .Thursday, dayOfTheMonth: 8),
        Cell(image: "AlpYucebilgin", speaker: "Alp Yucebilgin", extraSpeaker: 0, startingTime: "1900", endingTime: "1940", location: "Hall 3", title: "Metal Shader Debugging and Profilling", sessionNumber: 608, track: TrackType.featuredTrack, favorite: false, eventDescription: "blablabla", imageMap: "ExampleMap", speakerFunction: "Director of Animation", speakerCompany: "Pixar Animation Studios", speakerDescription: "Blablabla", cellType: .keynoteCell, dayOfTheWeek: .Thursday, dayOfTheMonth: 8),
        Cell(image: "JamesVest", speaker: "James Vest", extraSpeaker: 0, startingTime: "1900", endingTime: "1940", location: "Executive Ballroom", title: "VoiceOver: App Testing Beyond The Visuals", sessionNumber: 226, track: TrackType.designTrack, favorite: false, eventDescription: "blablabla", imageMap: "ExampleMap", speakerFunction: "Default Speaker", speakerCompany: "Pixar Animation Studios", speakerDescription: "Blablabla", cellType: .keynoteCell, dayOfTheWeek: .Thursday, dayOfTheMonth: 8),
        Cell(image: "RickB", speaker: "Rick Belamonte", extraSpeaker: 1, startingTime: "2000", endingTime: "2000", location: "Hall 2", title: "Getting to Know Swift Package Manager", sessionNumber: 441, track: TrackType.frameworksTrack, favorite: false, eventDescription: "blablabla", imageMap: "ExampleMap", speakerFunction: "Default Speaker", speakerCompany: "Pixar Animation Studios", speakerDescription: "Blablabla", cellType: .keynoteCell, dayOfTheWeek: .Thursday, dayOfTheMonth: 8),
        Cell(image: "WillLi", speaker: "Will Li", extraSpeaker: 1, startingTime: "2000", endingTime: "2030", location: "Hall 1", title: "Optimizing App Assets", sessionNumber: 227, track: TrackType.graphicsGamesTrack, favorite: false, eventDescription: "blablabla", imageMap: "ExampleMap", speakerFunction: "Default Speaker", speakerCompany: "Pixar Animation Studios", speakerDescription: "Blablabla", cellType: .keynoteCell, dayOfTheWeek: .Thursday, dayOfTheMonth: 8),
        Cell(image: "AnnaTikhonova", speaker: "Anna Tikhonova", extraSpeaker: 0, startingTime: "2000", endingTime: "2040", location: "Hall 3", title: "Metal for Accelerating Machine Learning", sessionNumber: 609, track: TrackType.featuredTrack, favorite: false, eventDescription: "blablabla", imageMap: "ExampleMap", speakerFunction: "Default Speaker", speakerCompany: "Default Company", speakerDescription: "Blablabla", cellType: .keynoteCell, dayOfTheWeek: .Thursday, dayOfTheMonth: 8),
        Cell(image: "ChrisM", speaker: "Chris Madelonovoas", extraSpeaker: 1, startingTime: "2100", endingTime: "2140", location: "Hall 2", title: "Advanced Debugging with Xcode and LLDB", sessionNumber: 412, track: TrackType.frameworksTrack, favorite: false, eventDescription: "blablabla", imageMap: "ExampleMap", speakerFunction: "Default Speaker", speakerCompany: "Default Company", speakerDescription: "Blablabla", cellType: .keynoteCell, dayOfTheWeek: .Thursday, dayOfTheMonth: 8),
        Cell(image: "MarionM", speaker: "Marion Madelonovoas", extraSpeaker: 1, startingTime: "2100", endingTime: "2140", location: "Hall 3", title: "Understanding ArKit Tracking and Detection", sessionNumber: 610, track: TrackType.featuredTrack, favorite: false, eventDescription: "blablabla", imageMap: "ExampleMap", speakerFunction: "Default Speaker", speakerCompany: "Default Company", speakerDescription: "Blablabla", cellType: .keynoteCell, dayOfTheWeek: .Thursday, dayOfTheMonth: 8)]
...
extension CellController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if event.extraSpeaker == 0 {
            ...
            if (names[0].count + names[1].count) < 8 {
                cell.speakerName.text = "\(names[0]) \(names[1])"
